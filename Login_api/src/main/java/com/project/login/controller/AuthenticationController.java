...
import com.project.login.model.dto.request.EmailRequest;
import com.project.login.model.dto.request.LoginRequest;
import com.project.login.model.dto.request.RegisterRequest;
import com.project.login.model.dto.request.ResetPasswordRequest;
import com.project.login.service.AuthService;
...
public class AuthenticationController {
    ...
    // 1) 登录
    // -------------------------------------------------------
    @Operation(summary = "User login", description = "Login with email or studentNumber and password")
    @PostMapping("/login")
