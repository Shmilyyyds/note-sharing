    ...
    <aside class="sidebar">
      <div class="search-bar-wrapper">
        <div class="search-input-box">
          <button class="search-icon-btn" @click.stop="handleSearch" title="点击搜索">🔍</button>
          <input type="text" placeholder="搜索笔记 Ctrl+Shift+F" />

          <div class="relative menu-wrapper" @click.stop>
            <button class="btn-icon list-view-icon" title="排序方式" @click="toggleSortMenu">
              ☰
            </button>
            <div v-if="showSortMenu" class="dropdown-menu sort-menu">
              <div class="menu-item" @click="handleSort('updatedAt')">修改时间</div>
              <div class="menu-item" @click="handleSort('createdAt')">创建时间</div>
            </div>
          </div>
        </div>
      </div>
...
const toggleSortMenu = () => {
  ...
  showNoteMenuId.value = null; // 关闭笔记操作菜单
};
